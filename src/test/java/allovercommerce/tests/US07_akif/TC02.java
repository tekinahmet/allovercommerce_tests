...
public class TC02 {
    ...
    //Then user should be able to verify that item prices are displayed on the page
    @Test
    public void US07_TC02(){

        LoggerUtils.info("Test case begins...");

        ExtentReportUtils.createTestReport("US07_TC02 Test Report", "Compare Products Page Test");
        ...
        Assert.assertFalse(allovCommerceComparePage.priceItem1.getText().isBlank());
        Assert.assertFalse(allovCommerceComparePage.priceItem2.getText().isBlank());
