...
public class TC04 {
    ...
    //Then user should be able to verify that item description info are displayed on the page(if item has)
    @Test
    public void US07_TC04(){

        LoggerUtils.info("Test case begins...");

        ExtentReportUtils.createTestReport("US07_TC04 Test Report", "Compare Products Page Test");
        ...
        Assert.assertFalse(allovCommerceComparePage.descriptionItem1.getText().isBlank());
