...
//User shouldn't be able to add  Billing Address without State name
//Go to webpage
...
//Click SAVE ADDRESS button
    ...
    public void US03_TC04(){
        ExtentReportUtils.createTestReport("US03_TC04", "Adding Billing Address");
        ...
        ExtentReportUtils.pass("Entered billing address information except State Name");

        //Verify that message shows up
        Assert.assertTrue(zeynepAddressesPage.assertMessage.isDisplayed());
        ExtentReportUtils.passAndCaptureScreenshot("Billing address could not save successfully, ''State is a required field.'' alert message is displayed on the page...");
        Driver.closeDriver();
