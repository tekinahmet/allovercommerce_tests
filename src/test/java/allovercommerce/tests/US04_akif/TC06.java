...
public class TC06 {
    ...
    public void US04_TC01(){
        ...
        ExtentReportUtils.createTestReport("US04_TC06 Test Report", "Adding Shipping Address Test");
        ...
        ExtentReportUtils.passAndCaptureScreenshot("Shipping address could not save successfully, ''Last name is a required field.'' alert message is displayed ont he page...");
