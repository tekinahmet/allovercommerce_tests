...
public class TC07 {
    ...
    public void US04_TC07(){
        ...
        ExtentReportUtils.createTestReport("US04_TC07 Test Report", "Adding Shipping Address Test");
        ...
        ExtentReportUtils.passAndCaptureScreenshot("Shipping address could not save successfully, ''Country/region is a required field.'' alert message is displayed ont he page...");
