...
public class TC04 {
    ...
    //User leaves Post/Zip code empty and should not be able to add/save shipping address
    //User should be able to see "Postcode / ZIP is a required field." alert message on the page
    @Test
    public void US04_TC04(){

        LoggerUtils.info("Test case begins...");

        ExtentReportUtils.createTestReport("US04_TC04 Test Report", "Adding Shipping Address Test");
        ...
        Assert.assertTrue(allovCommerceShippingAddressPage.postCodeFieldAlert.isDisplayed());

        ExtentReportUtils.passAndCaptureScreenshot("Shipping address could not save successfully, ''Postcode / ZIP is a required field.'' alert message is displayed ont he page...");
