...
public class TC03 {
    ...
    public void US04_TC03(){
        ...
        ExtentReportUtils.createTestReport("US04_TC03 Test Report", "Adding Shipping Address Test");
        ...
        ExtentReportUtils.passAndCaptureScreenshot("Shipping address could not save successfully, ''Town / City is a required field.'' alert message is displayed ont he page...");
